...
elseif(FIPS_EMSCRIPTEN_USE_WASM_ASMJS)
    set(EMSC_LINKER_FLAGS "${EMSC_LINKER_FLAGS} -s WASM=1 -s 'BINARYEN_METHOD=\"native-wasm,asmjs\"'")
endif()
...
# set file naming so emscripten llvm -> bitcode is clear
SET(CMAKE_OUTPUT_EXTENSION .o.bc)
SET(CMAKE_C_OUTPUT_EXTENSION .o.bc)
SET(CMAKE_CXX_OUTPUT_EXTENSION .o.bc)
SET(CMAKE_EXECUTABLE_SUFFIX .js)
SET(CMAKE_EXECUTABLE_SUFFIX_C .js)
SET(CMAKE_EXECUTABLE_SUFFIX_CXX .js)
SET(CMAKE_SHARED_LIBRARY_SUFFIX .so.bc)
SET(CMAKE_SHARED_LIBRARY_SUFFIX_C .so.bc)
SET(CMAKE_SHARED_LIBRARY_SUFFIX_CXX .so.bc)
