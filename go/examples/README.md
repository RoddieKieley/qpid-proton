...
[electron](http://godoc.org/github.com/roddiekieley/qpid-proton/go/pkg/electron) package provides a more
...
packages with
    ...
    go get github.com/roddiekieley/qpid-proton/go/pkg/electron
...
you should set these environment variables before `go get`:
    ...
    go get github.com/roddiekieley/qpid-proton
...
The [proton](http://godoc.org/github.com/roddiekieley/qpid-proton/go/pkg/proton) and
[electron](http://godoc.org/github.com/roddiekieley/qpid-proton/go/pkg/electron) packages provide two
different APIs for building AMQP applications. For most applications,
[electron](http://godoc.org/github.com/roddiekieley/qpid-proton/go/pkg/electron) is easier to use.
